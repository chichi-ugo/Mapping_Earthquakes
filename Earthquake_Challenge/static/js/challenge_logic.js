...
// D3 - Creating a new map style to add to map
...
let allEQs = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson"
d3.json(allEQs).then(function(data) {
  ...
  let EQs_major = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"
  d3.json(EQs_major).then(function(data) {
